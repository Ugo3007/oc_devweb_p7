...
import banner_src from '../assets/about_banner.png'
    ...
    return (
        <div className="about-container">
            <div className='banner-container'>
                <Banner img_src={banner_src} divText=''/>
            </div>
            <div>
                <Collapsible collapsibleTitle="Fiabilité" collapsibleContent={fiabilite}/>
                <Collapsible collapsibleTitle="Respect" collapsibleContent={respect}/>
                <Collapsible collapsibleTitle="Service" collapsibleContent={service}/>
                <Collapsible collapsibleTitle="Sécurité" collapsibleContent={securite}/>
            </div>
        </div>
    )
}